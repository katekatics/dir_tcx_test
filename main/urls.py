...
urlpatterns = [
    ...
    path('store/<str:full_sap>/products_super_price_report/', views.products_super_price_report, name='products_super_price_report'),
    path('store/<str:full_sap>/products_super_price/', views.products_super_price, name='products_super_price'),
